...
<head>
    ...
    <title>Welcome - Butterfly Effect</title>
    ...
    <style>
        ...
        /* Fullscreen Butterfly GIF background */
        .butterfly-background {
            ...
            width: 100vw;
            height: 100vh;
            background: url('picmix.com_1955106-ezgif.com-effects.gif') no-repeat center center / cover;
            z-index: -1; /* Keep it behind content */
            opacity: 0.7; /* Optional: make it soft */
        }
...
<body>
    ...
    <div class="butterfly-background"></div>

    <!-- Floating PNG Image -->
    <img src="https://raw.githubusercontent.com/Hirthick6/Oasis-Infobyte-Web-Development-and-Designing/main/3d-gif-transparent-20-removebg-preview.png" class="floating-image" alt="Butterfly PNG">

    <!-- Page Content -->
    <div class="content">
        <h1>Welcome to My GitHub Page</h1>
        <p>Enjoy the butterfly effect! 🦋✨</p>
    </div>
